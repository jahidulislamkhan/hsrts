    ...
    public function indexData()
    {
        ...
        return Datatables::of($categories)
            ...
            ->addColumn('actions', function($category){
                $button = '<a href="'.route('edit_category', $category->id).'" title="Edit" data-toggle="tooltip" data-placement="top"><i class="fa fa-pencil"></i> </a>&nbsp;&nbsp;';
                $button .= '<a href="javascript:;" class="text-danger deleteCategory" title="Delete" data-toggle="tooltip" data-placement="top" data-id="'.$category->id.'"><i class="fa fa-trash-o"></i> </a>';
                return $button;
            })
            ->removeColumn('id')
            ->make();
