...
class UserController extends Controller
{
    ...
    public function indexData()
    {
        ...
        if($user->isShopAdmin())
        {
            ...
            $agents = User::where('shop_id', $shop_id)->whereRaw(" (user_type = 'user' OR user_type = 'shop_admin')")->select('id', 'referral_id', 'first_name', 'last_name','shop_id', 'created_at')->with('shop');
        } else {
        ...
        return Datatables::of($agents)
            ...
            ->addColumn('action', function($agent){
                ...
                $btn .= '<a data-original-title="Edit" href="'.route('edit_agent', $agent->id).'" class="text-info" title="" data-toggle="tooltip" data-placement="top"><i class="fa fa-pencil"></i> </a>&nbsp;&nbsp;';

                $btn .= '<a data-original-title="Delete" href="javascript:;" class="text-danger deleteBrands" title="" data-toggle="tooltip" data-placement="top" data-id="'.$agent->id.'"><i class="fa fa-trash-o"></i> </a>';
    ...
    public function destroy(Request $request)
    {
        ...
        Activity::create(['user_id' => $user->id, 'activity' => 'You have deleted the user '.$user_name]);
        return $response;
    }
