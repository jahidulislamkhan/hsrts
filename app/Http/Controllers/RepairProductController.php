...
class RepairProductController extends Controller
{
        ...
        if($user->isSuperAdmin()) {
            ...
            return Datatables::of($invoices)
                ...
                ->addColumn('actions', function($invoice){
                    $button = '<a href="'.route('view_repair_invoice', $invoice->invoice_id).'" class="text-success" title="View" data-toggle="tooltip" data-placement="top"><i class="fa fa-eye"></i> </a>';
    ...
    {
        $pageTitle = 'Complete Repaired Products';
