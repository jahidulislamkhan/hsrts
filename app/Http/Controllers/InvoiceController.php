        ...
        if($user->isSuperAdmin()) {
            ...
            return Datatables::of($invoices)
                ...
                ->addColumn('actions', function($invoice){
                    $button = '<a href="'.route('admin_view_sales_invoice', $invoice->id).'" class="text-success" title="View" data-toggle="tooltip" data-placement="top"><i class="fa fa-eye"></i> </a>';
            ...
            return Datatables::of($invoices)
                ...
                ->addColumn('actions', function ($invoice) {
                    $button = '<a href="' . route('view_sales_invoice', $invoice->id) . '" class="text-success" title="View" data-toggle="tooltip" data-placement="top"><i class="fa fa-eye"></i> </a>';
