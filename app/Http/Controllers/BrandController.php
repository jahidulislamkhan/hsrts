    ...
    public function indexData()
    {
        ...
        return Datatables::of($brands)
            ...
            ->addColumn('actions', function($brand){
                $button = '<a href="'.route('edit_brand', $brand->id).'" title="Edit" data-toggle="tooltip" data-placement="top"><i class="fa fa-pencil"></i> </a>&nbsp;&nbsp;';
                $button .= '<a href="javascript:;" class="text-danger deleteBrands" title="Delete" data-toggle="tooltip" data-placement="top" data-id="'.$brand->id.'"><i class="fa fa-trash-o"></i> </a>';
                return $button;
            })
            ->removeColumn('id')
            ->make();
