    ...
    public function indexData()
    {
        ...
        return Datatables::of($products)
            ...
            ->addColumn('actions', function($product){
                $button = '<a href="'.route('view_product', $product->id).'" title="View" data-toggle="tooltip" data-placement="top"><i class="fa fa-eye"></i> </a>&nbsp;&nbsp;';
                $button .= '<a href="'.route('edit_product', $product->id).'" title="Edit" data-toggle="tooltip" data-placement="top"><i class="fa fa-pencil"></i> </a>&nbsp;&nbsp;';
                $button .= '<a href="javascript:;" class="text-danger deleteProduct" title="Delete" data-toggle="tooltip" data-placement="top" data-id="'.$product->id.'"><i class="fa fa-trash-o"></i> </a>';
                return $button;
            })
            ->removeColumn('id')
            ->removeColumn('brand')
