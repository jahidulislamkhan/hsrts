            ...
            <div class="box">
                ...
                <div class="box-body">
                        ...
                        <div class="col-sm-7">
                            <select class="select2 form-control" name="product">
                                ...
                                @foreach($products as $product)
                                    <option value="{{ $product->id }}" {{ $product->id == $stock->product_id ? 'selected': '' }} {{ $product->id == $stock->product_id ? '': 'disabled' }}>{{ $product->product_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group {{ $errors->has('total_product')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="total_product" class="form-control" value="{{ old('total_product') ? old('total_product') : $stock->total_product  }}" placeholder="Product Model">
                    ...
                    <div class="form-group">
                        <div class="col-sm-7 col-sm-offset-3">
                            <button type="submit" name="submit" class="btn btn-primary" required="required"><i class="fa fa-plus-square-o"></i> Update Stock</button>
                        </div>
                    </div>
