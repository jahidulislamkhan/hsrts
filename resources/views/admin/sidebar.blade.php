          ...
          <ul class="sidebar-menu">
              ...
              <li class="treeview {{ Request::is('admin/repair-product*')? 'active' :''  }}">
                  ...
                  <ul class="treeview-menu">
                      <li class="{{ Request::is('admin/repair-product')? 'active' :''  }}">
                          <a href="{{ route('all_repair_product') }}"><i class="fa fa-list-alt"></i> All repaired products </a>
                      </li>
                    <li class="{{ Request::is('admin/repair-product/completed')? 'active' :''  }}">
                      <a href="{{ route('completed_repair_product') }}"><i class="fa fa-list-alt"></i>  Completed repairs </a>
                    </li>
            ...
            <li class="treeview {{ Request::is('administrator/stock*')? 'active' :''  }}">
              ...
              <ul class="treeview-menu">
                ...
                <li class="{{ Request::is('administrator/stock/create')? 'active' :''  }}"><a href="{{ route('create_stock') }}"><i class="fa fa-plus-square"></i>Add Stock</a></li>
            ...
            <li class="treeview {{ Request::is('administrator/shop*')? 'active' :''  }}">
              ...
              <ul class="treeview-menu">
                ...
                <li class="{{ Request::is('administrator/shop/create')? 'active' :''  }}"><a href="{{ route('add_shop_admin') }}"><i class="fa fa-plus-square"></i> Add Shop </a></li>
              </ul>
            </li>
            <li class="treeview {{ Request::is('administrator/agents*')? 'active' :''  }}">
              ...
              <ul class="treeview-menu">
                <li class="{{ Request::is('administrator/agents')? 'active' :''  }}"><a href="{{ route('all_agents') }}"><i class="fa fa-list"></i> All Users </a></li>
                <li class="{{ Request::is('administrator/agents/create')? 'active' :''  }}"><a href="{{ route('admin_agent_create') }}"><i class="fa fa-plus-square-o"></i>Add User </a></li>
              </ul>
            </li>
