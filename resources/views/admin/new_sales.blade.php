                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group {{ $errors->has('customer_address')? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <p class="help-block">Address within 500 character, pressing enter will create new line</p>
                            ...
                            <div class="col-sm-12">
                                <div id="cartContent">
                                    ...
                                    @else
                                        <p>There are no products added to the list. Please add some products to complete the sale.</p>
                                    @endif
