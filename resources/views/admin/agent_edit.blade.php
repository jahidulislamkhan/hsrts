            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('mobile_number')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="number" name="mobile_number" class="form-control" value="{{ old('mobile_number') ? old('mobile_number') : $user->mobile }}" placeholder="Mobile Number">
                    ...
                    <div class="form-group {{ $errors->has('user_type')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <label><input type="radio" name="user_type" value="shop_admin" {{ $user->user_type == 'shop_admin' ? 'checked' : '' }} /> Shop Admin</label>
                            <label> <input type="radio" name="user_type" value="user" {{ $user->user_type == 'user' ? 'checked' : '' }} /> Shop Employee</label>
                    ...
                    <div class="form-group">
                        <div class="col-sm-7 col-sm-offset-3">
                            <button type="submit" name="submit" class="btn btn-primary" required="required"><i class="fa fa-plus-square-o"></i> Update User</button>
                        </div>
                    </div>
