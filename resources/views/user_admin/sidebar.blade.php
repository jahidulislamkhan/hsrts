            ...
            @if(Auth::user()->isShopAdmin())
              ...
              <li class="treeview {{ Request::is('admin/shop/sales*')? 'active' :''  }}">
                ...
                <ul class="treeview-menu">
                  ...
                  <li class="{{ Request::is('admin/shop/sales/create')? 'active' :''  }}"><a href="{{ route('user_new_sales') }}"><i class="fa fa-plus-square-o"></i>New Sale </a></li>
                </ul>
              </li>
              ...
              <li class="treeview {{ Request::is('admin/shop/agents*')? 'active' :''  }}">
                ...
                <ul class="treeview-menu">
                  <li class="{{ Request::is('admin/shop/agents')? 'active' :''  }}">
                    <a href="{{ route('user_agent_list') }}"><i class="fa fa-list-alt"></i> Users </a>
                  </li>
                  <li class="{{ Request::is('admin/shop/agents/create')? 'active' :''  }}"><a href="{{ route('user_agent_create') }}"><i class="fa fa-plus-square-o"></i>Add User </a></li>
                </ul>
              </li>
